...
if(!$fun->isAjax()){header ("Location: ../../mods/panel/panel.php");}
  ...
  //=============Definimos funciones===================
	...
	//desactivar persona: Inhabilita usuario para ser tenido en cuenta para futuras programaciones de despachos
	function des_persona(){
		$fun = new funciones();
		$msg = new messages();
		$response = new StdClass;
	...
	//activar persona: Habilita usuario para ser tenido en cuenta para futuras programaciones de despachos
	function act_persona(){
		$fun = new funciones();
		$msg = new messages();
		$response = new StdClass;
